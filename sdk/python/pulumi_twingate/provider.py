...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] http_max_retry: Specifies a retry limit for the http requests made. This setting is 5. Alternatively, this can be specified using the
